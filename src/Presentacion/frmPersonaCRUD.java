...
public class frmPersonaCRUD extends javax.swing.JFrame {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        Persona P = new Persona(Integer.parseInt(txtID.getText()), txtNombre.getText(), txtPaterno.getText(), txtMaterno.getText(), 
                Integer.parseInt(txtTelefono.getText()), txtCorreo.getText(), txtDireccion.getText());
